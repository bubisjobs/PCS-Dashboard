...
(function ($) {
    ...
    var submitFormQueries = document.querySelector("#formQueries");
    ...
    try {
        ...
        if (aa > aa1 || submitFormQueries.date1.value == "" || submitFormQueries.date2.value == "") {
            ...
            $(document).ready(function () {
                ...
                var table = $('.QueriesTbl').DataTable({
                    orderCellsTop: true,
                    pageLength: 24,
                    fixedHeader: true,
                    destroy: true,
                    ...
                    ajax: {
                        "url": `/pcs/main/Queries?date1=${date1}&date2=${date2}`,
                        "dataSrc": ""
